...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Answer: 'inject' works like 'reduce' in other languages, where the parameter to it is the starting value,
    #          the block is the reducer function, getting the current result and the element to reduce.
  end
  ...
  #
  # Temporary answer: If the blocks in Ruby work like the with statements in python, the blocks make sure to close out resources.
