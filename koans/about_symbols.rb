...
class AboutSymbols < Neo::Koan
  ...
  # Answer: Because a string can also be put in by a user...?
  ...
  # Answer: Because they can become memory hogs (see: https://stackoverflow.com/questions/4573991/why-is-it-not-a-good-idea-to-dynamically-create-a-lot-of-symbols-in-ruby)
end
