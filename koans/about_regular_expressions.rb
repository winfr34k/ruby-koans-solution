...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # Answer: Because they 'consume' as many characters as possible until a certain pattern is broken.
  ...
  # Answer: While a character class describes the (un-)allowed characters in a search, an alternation allows for differen variations of that search.
